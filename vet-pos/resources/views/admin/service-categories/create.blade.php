...
<div class="max-w-lg">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold mt-2">Add Service Category</h1>
    </div>
    <form method="POST" action="{{ route('admin.service-categories.store') }}" class="bg-white rounded-lg border border-gray-200 p-6 space-y-4">
        @csrf
        <div>
