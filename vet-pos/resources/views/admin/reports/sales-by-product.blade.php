@extends('layouts.app')
@section('title', 'Sales by Product - VetPOS')
@section('content')
<h1 class="text-2xl font-bold mb-6">Sales by Product</h1>
...
<div class="bg-white rounded-lg border border-gray-200 overflow-x-auto">
    <table class="w-full text-sm">
        <thead class="bg-gray-50"><tr><th class="text-left px-4 py-2">Product</th><th class="text-right px-4 py-2">Qty Sold</th><th class="text-right px-4 py-2">Revenue</th></tr></thead>
        <tbody class="divide-y divide-gray-100">
            @forelse($data as $row)
            <tr class="hover:bg-gray-50">
                <td class="px-4 py-2 font-medium">{{ $row->product->name ?? 'Deleted' }}</td>
