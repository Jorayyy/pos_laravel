@extends('layouts.app')
@section('title', 'Product Categories - VetPOS')
@section('content')
<div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl font-bold">Product Categories</h1>
    <a href="{{ route('admin.product-categories.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700">+ Add Category</a>
</div>
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 text-gray-600">
                <tr>
                    ...
                    <th class="text-center px-4 py-2">Products</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-right space-x-2">
                        <a href="{{ route('admin.product-categories.edit', $cat) }}" class="text-blue-600 hover:underline text-xs">Edit</a>
                        <form method="POST" action="{{ route('admin.product-categories.destroy', $cat) }}" class="inline" onsubmit="return confirm('Delete?')">
                            @csrf @method('DELETE')
